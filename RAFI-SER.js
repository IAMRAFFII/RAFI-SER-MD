...
const reply = (teks) => {
            XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": ` 🍒Join Bot's Official GC🍒`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./XeonMedia/rafi.jpeg`),"sourceUrl": "https://chat.whatsapp.com/BzKwmGl4Fck6YiqugLTJbA"}}}, { quoted: m})
        }
...
break
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            case 'bcgc': case 'bcgroup': {
                if (!isCreator) return replay(`${mess.owner}`)
                if (!text) return replay(`Where Is The Text?\n\nExample : ${prefix + command} Rafi Handsome`)
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                      ...
                      let txt = `「 *RAFI-SER Bot Broadcast* 」\n\n${text}`
            ...
            case 'bc': case 'broadcast': case 'bcall': {
                if (!isCreator) return replay(`${mess.owner}`)
                if (!text) return replay(`Where Is The Text?\n\nExample : ${prefix + command} RAFI SER`)
	    ...
	    break
            case 'listpc': case 'pclist': {
             ...
             break
            case 'sticker': case 'stcr': case 'stickergif': case 'sgif': {
...
break
	    ...
	    let apirnobg = ['q61faXzzR5zNU6cvcrwtUkRU','S258diZhcuFJooAtHTaPEn4T','5LjfCVAp4vVNYiTjq9mXJWHF','aT7ibfUsGSwFyjaPZ9eoJc61','BY63t7Vx2tS68YZFY6AJ4HHF','5Gdq1sSWSeyZzPMHqz7ENfi8','86h6d6u4AXrst4BVMD9dzdGZ','xp8pSDavAgfE5XScqXo9UKHF','dWbCoCb3TacCP93imNEcPxcL','HJhwZxxrbN4STtGFWZqLXuXt']
	    ...
	    case 'yts': case 'ytsearch': {
            ...
            break
        case 'google': {
                if (!text) return reply(`Example : ${prefix + command} search anything`)
...
case 'webtonsearch': case 'webtoon':
		...
		let { quotesAnime } = require('./lib/scraper')
            ...
            break
	    case 'numberhoki': case 'nomorhoki': {
                if (!Number(text)) return reply(`Example : ${prefix + command} 919605741366`)
...
break
                    case 'bug': case 'report': {
                    	...
                    	XeonBotInc.sendMessage(`919605741366@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${m.sender.split("@")[0]}
Report Message: ${text}` })
reply(`Successfully Reported To The Owner\n\nPlease Make Sure The Bug Is Valid, If You Play With This, Use This Feature Again And Again For No Reason, You Will Be Blocked For Sure !`)
                    }
                    break
                    case 'tes': case 'test': case 'alive': case 'bot': case 'robot': case 'Hi': case 'Mdbot':{
                           	timestampe = speed();
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
    ...
    case 'donasi': case 'donate': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                XeonBotInc.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/6ba2aed56665a068e91f.jpg' }, caption: `*Hi Bro ${m.pushName}*\n\nDonate Me : \n\n🍒 Fampay : https://telegra.ph/file/6ba2aed566865a068e91.jpg\n💫 Paytm : https://telegra.ph/file/577bd4f28d90ca27f369.jpg\n\nIf You Want To Donate, Talk With The Owner First\nwa.me/919605741366 (Click To Contact)` }, { quoted: m })
            }
            break
            case 'sc': case 'script': {
                reply(`GitHub : https://github.com/n\n\nInstagram : ${myweb}\nDont Forget To Follow me`)
            }
            break
case 'allmenu': {
  	anu = `
...
┃╠ ${prefix}suitpvp [tag]
┃╠═══════✪「 CONVERTER 」
┃╠ ${prefix}photo [reply stick]
┃╠ ${prefix}sticker [reply img|gif]
┃╠ ${prefix}emojimix [emoji+emoji]
┃╠ ${prefix}video [reply img]
┃╠ ${prefix}gif [reply stick]
┃╠ ${prefix}url [reply img]
┃╠ ${prefix}unvoice [reply aud]
┃╠ ${prefix}mp3 [reply vn]
┃╠ ${prefix}audio [reply vid]
...
┃╠ ${prefix}report [bug]
┃╚═════════════✪
┗━━「 ${pushname} 」━⭓`,unicorn, [{"urlButton": {"displayText": "🍒Insta🍒","url": `${myweb}`}},{"urlButton": {"displayText": "🍒Script🍒","url": `${sc}`}},{"quickReplyButton": {"displayText": "🍜Donate🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "🍒Owner🍒","id": 'owner'}}] )
break
...
Xeon
Rafi (me)
And All Friends Who Helped Assemble This  Script !!!`,unicorn, [{"urlButton": {"displayText": "🍒Insta🍒","url": `${myweb}`}},{"urlButton": {"displayText": "🍒Script🍒","url": `${sc}`}},{"quickReplyButton": {"displayText": "🍜Donate🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "🍒Owner🍒","id": 'owner'}}] )
break
            default:
                if (budy.startsWith('=>')) {
